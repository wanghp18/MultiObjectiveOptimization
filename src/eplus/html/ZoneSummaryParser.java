...
public class ZoneSummaryParser {
    ...
    private final int zoneGrossWallAreaIndex = 6;
    private final int zoneWindowGlassAreaIndex = 7;
    private final int zoneLPDIndex = 8;
    private final int zoneOccupantIndex = 9;
    private final int zoneEPDIndex = 10;
